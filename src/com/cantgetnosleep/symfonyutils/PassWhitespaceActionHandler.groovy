 ...
 */
class PassWhitespaceActionHandler extends EditorWriteActionHandler {

    Class clazz;

    public PassWhitespaceActionHandler(Class clazz) {
        this.clazz = clazz;
    }
    ...
    public void executeWriteAction(Editor editor, DataContext dataContext) {
        ...
        String result = clazz.transform(selectedText.trim(), whitespace)
